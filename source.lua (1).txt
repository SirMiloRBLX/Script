...
--Lucide Icons https://raw.githubusercontent.com/AhmadV99/Main/refs/heads/main/Icons.lua - Created by Lucide Icon Team
local Icons = {}

local Success, Response = pcall(function()
    local Source = game:HttpGet("https://raw.githubusercontent.com/AhmadV99/Main/refs/heads/main/Icons.lua")
...
local function GetIcon(IconName)
    ...
    return Icons[IconName] or (string.find(IconName, "rbxassetid://") and IconName) or nil
end
...
function OrionLib:MakeNotification(NotificationConfig)
	...
	if NotificationConfig.Image and NotificationConfig.Image ~= "" then
